...
#ifndef __padthv1widget_wave_h
#define __padthv1widget_wave_h

#include <QFrame>


// Forward decl.
class padthv1_wave_lf;


//----------------------------------------------------------------------------
// padthv1widget_wave -- Custom widget

class padthv1widget_wave : public QFrame
{
	Q_OBJECT
...
#endif	// __padthv1widget_wave_h


// end of padthv1widget_wave.h
