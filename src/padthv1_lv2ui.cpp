...
static LV2UI_Handle padthv1_lv2ui_windows_instantiate (
	const LV2UI_Descriptor *, const char *, const char *,
	LV2UI_Write_Function write_function,
	LV2UI_Controller controller, LV2UI_Widget *widget,
	const LV2_Feature *const *ui_features )
...
#ifdef CONFIG_LV2_UI_WINDOWS
static const LV2UI_Descriptor padthv1_lv2ui_windows_descriptor =
{
	PADTHV1_LV2UI_WINDOWS_URI,
	padthv1_lv2ui_windows_instantiate,
	padthv1_lv2ui_cleanup,
	padthv1_lv2ui_port_event,
	padthv1_lv2ui_extension_data
};
...
LV2_SYMBOL_EXPORT const LV2UI_Descriptor *lv2ui_descriptor ( uint32_t index )
{
	...
	if (index == 1)
		return &padthv1_lv2ui_windows_descriptor;
	else
#endif
#ifdef CONFIG_LV2_UI_EXTERNAL
	if (index == 2)
