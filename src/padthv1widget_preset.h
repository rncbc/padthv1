...
#ifndef __padthv1widget_preset_h
#define __padthv1widget_preset_h
...
class padthv1widget_preset : public QWidget
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	padthv1widget_preset(QWidget *pParent = nullptr);
	...
	void reloadPresets(padthv1_presets *pPresets = nullptr);
...
private:
	...
	padthv1widget_presets::ComboBox *m_pComboBox;
...
#endif  // __padthv1widget_preset_h

// end of padthv1widget_preset.h
