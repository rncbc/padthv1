...
//-------------------------------------------------------------------------
// padthv1_presets - Bank/presets database class (singleton).
//

// ctor.
padthv1_presets::padthv1_presets (void)
...
void padthv1_presets::Bank::add_preset ( const QString& preset_name )
{
...
void padthv1_presets::Bank::remove_preset ( const QString& preset_name )
{
	m_preset_list.removeAll(preset_name);
}


void padthv1_presets::Bank::clear_presets (void)
{
	m_preset_list.clear();
}
...
// bank managers
padthv1_presets::Bank *padthv1_presets::find_bank (
...
padthv1_presets::Bank *padthv1_presets::find_preset_bank (
...
padthv1_presets::Bank *padthv1_presets::add_bank (
...
void padthv1_presets::remove_bank ( const QString& bank_name )
{
	Bank *bank = find_bank(bank_name);
...
void padthv1_presets::clear_banks (void)
{
	m_current_bank = nullptr;
...
// preset managers
padthv1_presets::Preset *padthv1_presets::find_preset (
	const QString& preset_name ) const
{
...
padthv1_presets::Preset *padthv1_presets::add_preset (
...
void padthv1_presets::remove_preset ( const QString& preset_name )
{
...
void padthv1_presets::clear_presets (void)
{
...
void padthv1_presets::set_current_bank ( const QString& bank_name )
{
	m_current_bank = find_bank(bank_name);
}


void padthv1_presets::set_current_preset ( const QString& preset_name )
{
	m_current_preset = find_preset(preset_name);
}


// end of padthv1_presets.cpp
