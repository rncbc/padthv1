...
#ifndef __padthv1widget_keybd_h
#define __padthv1widget_keybd_h
...
class padthv1widget_keybd : public QWidget
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	padthv1widget_keybd(QWidget *pParent = 0);
...
#endif  // __padthv1widget_keybd_h

// end of padthv1widget_keybd.h
