...
#include "ui_padthv1widget_palette.h"
...
padthv1widget_palette::padthv1widget_palette ( QWidget *parent, const QPalette& pal )
	: QDialog(parent), p_ui(new Ui::padthv1widget_palette), m_ui(*p_ui)
{
	m_ui.setupUi(this);
...
padthv1widget_palette::~padthv1widget_palette (void)
{
	setSettings(nullptr);
}


void padthv1widget_palette::setPalette ( const QPalette& pal )
{
	m_palette = pal;
...
void padthv1widget_palette::setPalette ( const QPalette& pal, const QPalette& parentPal )
{
...
const QPalette& padthv1widget_palette::palette (void) const
{
	return m_palette;
}


void padthv1widget_palette::setSettings ( QSettings *settings, bool owner )
{
...
QSettings *padthv1widget_palette::settings (void) const
{
	return m_settings;
}


void padthv1widget_palette::nameComboChanged ( const QString& name )
{
...
void padthv1widget_palette::saveButtonClicked (void)
{
...
void padthv1widget_palette::deleteButtonClicked (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
void padthv1widget_palette::generateButtonChanged (void)
{
	const QColor& color
...
void padthv1widget_palette::resetButtonClicked (void)
{
...
void padthv1widget_palette::detailsCheckClicked (void)
{
...
void padthv1widget_palette::importButtonClicked (void)
{
	const QString& title
...
void padthv1widget_palette::exportButtonClicked (void)
{
	const QString& title
...
void padthv1widget_palette::paletteChanged ( const QPalette& pal )
{
	m_modelUpdated = true;
	if (!m_paletteUpdated)
		setPalette(pal);
...
void padthv1widget_palette::setPaletteName ( const QString& name )
{
...
QString padthv1widget_palette::paletteName (void) const
{
	return m_ui.nameCombo->currentText();
}


void padthv1widget_palette::updateNamedPaletteList (void)
{
	const bool blocked = m_ui.nameCombo->blockSignals(true);
...
void padthv1widget_palette::updateGenerateButton (void)
{
...
void padthv1widget_palette::updateDialogButtons (void)
{
	const QString& name = m_ui.nameCombo->currentText();
...
bool padthv1widget_palette::namedPalette ( const QString& name, QPalette& pal ) const
{
	return namedPalette(m_settings, name, pal);
}


bool padthv1widget_palette::namedPalette (
...
QStringList padthv1widget_palette::namedPaletteList (void) const
{
	return namedPaletteList(m_settings);
}


QStringList padthv1widget_palette::namedPaletteList ( QSettings *settings )
{
	QStringList list;
...
QString padthv1widget_palette::namedPaletteConf ( const QString& name ) const
{
	return namedPaletteConf(m_settings, name);
}


QString padthv1widget_palette::namedPaletteConf (
...
void padthv1widget_palette::addNamedPaletteConf (
...
void padthv1widget_palette::deleteNamedPaletteConf ( const QString& name )
{
	if (m_settings) {
...
bool padthv1widget_palette::loadNamedPaletteConf (
...
bool padthv1widget_palette::saveNamedPaletteConf (
...
bool padthv1widget_palette::loadNamedPalette (
		...
		if (name2 == name) {
			...
			while (iter.hasNext()) {
				...
				const QPalette::ColorRole cr
					= padthv1widget_palette::colorRole(key);
...
bool padthv1widget_palette::saveNamedPalette (
...
QPalette::ColorRole padthv1widget_palette::colorRole ( const QString& name )
{
...
bool padthv1widget_palette::isDirty (void) const
{
	return (m_dirtyTotal > 0);
}


void padthv1widget_palette::accept (void)
{
...
void padthv1widget_palette::reject (void)
{
	if (m_dirtyCount > 0) {
...
void padthv1widget_palette::setDefaultDir ( const QString& dir )
{
	if (m_settings) {
...
QString padthv1widget_palette::defaultDir (void) const
{
	QString dir;
...
void padthv1widget_palette::setShowDetails ( bool on )
{
	if (m_settings) {
		m_settings->beginGroup(PaletteEditorGroup);
...
bool padthv1widget_palette::isShowDetails (void) const
{
	bool on = false;
...
void padthv1widget_palette::showEvent ( QShowEvent *event )
{
...
void padthv1widget_palette::resizeEvent ( QResizeEvent *event )
{
...
padthv1widget_palette::PaletteModel::PaletteModel ( QObject *parent )
...
int padthv1widget_palette::PaletteModel::rowCount ( const QModelIndex& ) const
{
	return m_nrows;
}


int padthv1widget_palette::PaletteModel::columnCount ( const QModelIndex& ) const
{
	return 4;
}


QVariant padthv1widget_palette::PaletteModel::data ( const QModelIndex& index, int role ) const
{
	if (!index.isValid())
		return QVariant();
...
bool padthv1widget_palette::PaletteModel::setData (
...
Qt::ItemFlags padthv1widget_palette::PaletteModel::flags ( const QModelIndex& index ) const
{
	if (!index.isValid())
...
QVariant padthv1widget_palette::PaletteModel::headerData (
...
const QPalette& padthv1widget_palette::PaletteModel::palette(void) const
{
	return m_palette;
}


void padthv1widget_palette::PaletteModel::setPalette (
...
QPalette::ColorGroup padthv1widget_palette::PaletteModel::columnToGroup ( int index ) const
{
	if (index == 1)
...
int padthv1widget_palette::PaletteModel::groupToColumn ( QPalette::ColorGroup group ) const
{
...
QWidget *padthv1widget_palette::ColorDelegate::createEditor ( QWidget *parent,
...
void padthv1widget_palette::ColorDelegate::setEditorData (
...
void padthv1widget_palette::ColorDelegate::setModelData ( QWidget *editor,
...
void padthv1widget_palette::ColorDelegate::updateEditorGeometry ( QWidget *editor,
...
void padthv1widget_palette::ColorDelegate::paint ( QPainter *painter,
	const QStyleOptionViewItem& option, const QModelIndex& index ) const
{
...
QSize padthv1widget_palette::ColorDelegate::sizeHint (
	const QStyleOptionViewItem& option, const QModelIndex &index) const
{
...
padthv1widget_palette::ColorButton::ColorButton ( QWidget *parent )
...
const QBrush& padthv1widget_palette::ColorButton::brush (void) const
{
	return m_brush;
}


void padthv1widget_palette::ColorButton::setBrush ( const QBrush& brush )
{
	m_brush = brush;
	update();
}
...
void padthv1widget_palette::ColorButton::paintEvent ( QPaintEvent *event )
{
...
void padthv1widget_palette::ColorButton::chooseColor (void)
{
	const QColor color
...
//-------------------------------------------------------------------------
// padthv1widget_palette::ColorEditor

padthv1widget_palette::ColorEditor::ColorEditor ( QWidget *parent )
	: QWidget(parent)
{
	QLayout *layout = new QHBoxLayout(this);
	layout->setContentsMargins(0, 0, 0, 0);
	m_button = new padthv1widget_palette::ColorButton(this);
...
void padthv1widget_palette::ColorEditor::setColor ( const QColor& color )
{
...
QColor padthv1widget_palette::ColorEditor::color (void) const
{
	return m_button->brush().color();
}


void padthv1widget_palette::ColorEditor::colorChanged (void)
{
	m_changed = true;
	emit changed(this);
}
...
bool padthv1widget_palette::ColorEditor::changed (void) const
{
	return m_changed;
}
...
padthv1widget_palette::RoleEditor::RoleEditor ( QWidget *parent )
	: QWidget(parent)
{
	m_edited = false;
...
void padthv1widget_palette::RoleEditor::setLabel ( const QString& label )
{
	m_label->setText(label);
}


void padthv1widget_palette::RoleEditor::setEdited ( bool on )
{
	QFont font;
	if (on)
		font.setBold(on);
...
bool padthv1widget_palette::RoleEditor::edited (void) const
{
	return m_edited;
}


void padthv1widget_palette::RoleEditor::resetProperty (void)
{
	setEdited(false);
	emit changed(this);
}
...
// end of padthv1widget_palette.cpp
