...
#ifndef __padthv1widget_presets_h
#define __padthv1widget_presets_h
...
//----------------------------------------------------------------------------
// padthv1widget_presets -- Custom (tree) widget.

class padthv1widget_presets : public QTreeWidget
{
	Q_OBJECT
...
public:
	...
	// ctor.
	padthv1widget_presets(QWidget *pParent = nullptr);
	// dtor.
	~padthv1widget_presets();
...
// custom combo-box decl.
//
class padthv1widget_presets::ComboBox : public QComboBox
{
	Q_OBJECT
...
public:
	...
	padthv1widget_presets *presetsView() const;
...
private:
	...
	padthv1widget_presets *m_pPresetsView;
};


#endif	// __padthv1widget_presets_h

// end of padthv1widget_presets.h
