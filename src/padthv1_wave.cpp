...
// ctor.
padthv1_wave::padthv1_wave ( uint32_t nsize, uint16_t nover )
...
// dtor.
padthv1_wave::~padthv1_wave (void)
{
	delete [] m_table;
}
...
// init.
void padthv1_wave::reset ( Shape shape, float width )
{
	m_shape = shape;
	m_width = width;;
...
// init pulse table.
void padthv1_wave::reset_pulse (void)
{
...
// init saw table.
void padthv1_wave::reset_saw (void)
{
	const float p0 = float(m_nsize);
...
// init sine table.
void padthv1_wave::reset_sine (void)
{
	const float p0 = float(m_nsize);
	const float w0 = p0 * m_width;
...
// init random table.
void padthv1_wave::reset_rand (void)
{
	const float p0 = float(m_nsize);
	const float w0 = p0 * m_width;
...
// init noise table.
void padthv1_wave::reset_noise (void)
{
	const float p0 = float(m_nsize);
	const float w0 = p0 * m_width;
...
// post-processors
void padthv1_wave::reset_filter (void)
{
	uint32_t i, k = 0;
...
void padthv1_wave::reset_normalize (void)
{
	uint32_t i;
...
void padthv1_wave::reset_interp (void)
{
	uint32_t i, pk = 0;
