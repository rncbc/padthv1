...
// ctor.
padthv1widget_programs_item_delegate::padthv1widget_programs_item_delegate (
...
QSize padthv1widget_programs_item_delegate::sizeHint (
...
QWidget *padthv1widget_programs_item_delegate::createEditor ( QWidget *pParent,
	const QStyleOptionViewItem& /*option*/, const QModelIndex& index ) const
{
	...
	qDebug("padthv1widget_programs_item_delegate::createEditor(%p, %d, %d) = %p",
...
void padthv1widget_programs_item_delegate::setEditorData (
	QWidget *pEditor, const QModelIndex& index ) const
{
#ifdef CONFIG_DEBUG_0
	qDebug("padthv1widget_programs_item_delegate::setEditorData(%p, %d, %d)",
...
void padthv1widget_programs_item_delegate::setModelData ( QWidget *pEditor,
	QAbstractItemModel *pModel,	const QModelIndex& index ) const
{
#ifdef CONFIG_DEBUG_0
	qDebug("padthv1widget_programs_item_delegate::setModelData(%p, %d, %d)",
		pEditor, index.row(), index.column());
#endif
	...
	: QTreeWidget(pParent)
{
	...
	QTreeWidget::setItemDelegate(new padthv1widget_programs_item_delegate(this));
...
void padthv1widget_programs::selectProgram ( padthv1_programs *pPrograms )
{
