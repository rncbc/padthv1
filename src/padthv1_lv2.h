...
#ifndef __padthv1_lv2_h
#define __padthv1_lv2_h
...
#define PADTHV1_LV2_URI "http://padthv1.sourceforge.net/lv2"
#define PADTHV1_LV2_PREFIX PADTHV1_LV2_URI "#"
...
class padthv1_lv2 : public padthv1
{
public:

	padthv1_lv2(double sample_rate, const LV2_Feature *const *host_features);
...
protected:
	...
	bool port_event(padthv1::ParamIndex index);
	bool port_events();
#endif

#ifdef CONFIG_LV2_PORT_CHANGE_REQUEST
	bool port_change_request(padthv1::ParamIndex index);
...
#endif// __padthv1_lv2_h

// end of padthv1_lv2.h
