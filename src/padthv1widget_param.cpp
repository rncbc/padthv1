...
padthv1widget_param_style *padthv1widget_param_style::g_pStyle = nullptr;
...
void padthv1widget_param::setValue ( float fValue )
{
	QPalette pal;
...
void padthv1widget_knob::setValue ( float fValue )
{
	const bool bDialBlock = m_pDial->blockSignals(true);
	padthv1widget_param::setValue(fValue);
...
QValidator::State padthv1widget_edit::validate ( QString& sText, int& iPos ) const
{
...
// Virtual accessors.
void padthv1widget_spin::setValue ( float fValue )
{
	const bool bSpinBlock = m_pSpinBox->blockSignals(true);
	padthv1widget_knob::setValue(fValue);
...
// Virtual accessors.
void padthv1widget_combo::setValue ( float fValue )
{
...
// Virtual accessors.
void padthv1widget_radio::setValue ( float fValue )
{
...
// Virtual accessors.
void padthv1widget_check::setValue ( float fValue )
{
...
// Constructor.
padthv1widget_group::padthv1widget_group ( QWidget *pParent )
	: QGroupBox(pParent)
{
	padthv1widget_param_style::addRef();
#if 0
...
#endif
	QGroupBox::setStyle(padthv1widget_param_style::getRef());

	m_pParam = new padthv1widget_param(this);
...
// Destructor.
padthv1widget_group::~padthv1widget_group (void)
{
	padthv1widget_param_style::releaseRef();
...
// Accessors.
void padthv1widget_group::setToolTip ( const QString& sToolTip )
{
	m_pParam->setToolTip(sToolTip);
}


QString padthv1widget_group::toolTip (void) const
{
	return m_pParam->toolTip();
}


padthv1widget_param *padthv1widget_group::param (void) const
{
	return m_pParam;
}
...
// Virtual accessors.
void padthv1widget_group::paramValueChanged ( float fValue )
{
...
void padthv1widget_group::groupBoxValueChanged ( bool bGroupValue )
{
	const float fMaximum = m_pParam->maximum();
	const float fMinimum = m_pParam->minimum();
