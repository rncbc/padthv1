...
void padthv1widget_config::loadComboBoxHistory ( QComboBox *pComboBox, int iLimit )
{
	padthv1_config *pConfig = padthv1_config::getInstance();
	if (pConfig == NULL)
		return;
...
void padthv1widget_config::saveComboBoxHistory ( QComboBox *pComboBox, int iLimit )
{
	padthv1_config *pConfig = padthv1_config::getInstance();
	if (pConfig == NULL)
		return;
