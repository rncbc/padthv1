...
void padthv1_tuning::reset ( float refPitch, int refNote )
{
	m_refPitch = refPitch;
	m_refNote  = refNote;
	m_zeroNote = 0;
...
void padthv1_tuning::updateBasePitch	(void)
{
	// Clever, huh?
	m_basePitch = 1.0f;
...
bool padthv1_tuning::loadKeyMapFile ( const QString& keyMapFile )
{
...
bool padthv1_tuning::loadScaleFile ( const QString& scaleFile )
{
...
float padthv1_tuning::parseScaleLine ( const QString& line ) const
{
	bool ok = false;
...
float padthv1_tuning::noteToPitch ( int note ) const
{
