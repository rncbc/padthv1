...
// Constructor.
padthv1widget_filt::padthv1widget_filt ( QWidget *pParent )
	: QFrame(pParent),
...
// Destructor.
padthv1widget_filt::~padthv1widget_filt (void)
{
}


// Parameter accessors.
void padthv1widget_filt::setCutoff ( float fCutoff )
{
...
float padthv1widget_filt::cutoff (void) const
{
	return m_fCutoff;
}


void padthv1widget_filt::setReso ( float fReso )
{
...
float padthv1widget_filt::reso (void) const
{
	return m_fReso;
}


void padthv1widget_filt::setType ( float fType )
{
...
float padthv1widget_filt::type (void) const
{
	return float(m_iType);
}


void padthv1widget_filt::setSlope ( float fSlope )
{
...
float padthv1widget_filt::slope (void) const
{
...
// Draw curve.
void padthv1widget_filt::paintEvent ( QPaintEvent *pPaintEvent )
{
...
// Drag/move curve.
void padthv1widget_filt::dragCurve ( const QPoint& pos )
{
	const int h  = height();
	const int w  = width();
...
// Mouse interaction.
void padthv1widget_filt::mousePressEvent ( QMouseEvent *pMouseEvent )
{
...
void padthv1widget_filt::mouseMoveEvent ( QMouseEvent *pMouseEvent )
{
...
void padthv1widget_filt::mouseReleaseEvent ( QMouseEvent *pMouseEvent )
{
...
void padthv1widget_filt::wheelEvent ( QWheelEvent *pWheelEvent )
{
...
// Resize canvas.
void padthv1widget_filt::resizeEvent ( QResizeEvent *pResizeEvent )
{
...
void padthv1widget_filt::updatePath (void)
{
	const QRect& rect = QWidget::rect();
	const int h  = rect.height();
	const int w  = rect.width();
