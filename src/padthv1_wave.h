...
#ifndef __padthv1_wave_h
#define __padthv1_wave_h

#include <stdint.h>


//-------------------------------------------------------------------------
// padthv1_wave - smoothed (integrating oversampled) wave table.
//
...
public:
	...
	// ctor.
	padthv1_wave(uint32_t nsize = 4096, uint16_t nover = 24);
...
//-------------------------------------------------------------------------
// padthv1_wave_lf - hard/non-smoothed wave table (eg. LFO).
//

class padthv1_wave_lf : public padthv1_wave
{
public:

	// ctor.
	padthv1_wave_lf(uint32_t nsize = 1024)
		: padthv1_wave(nsize, 0) {}
};


//-------------------------------------------------------------------------
// padthv1_oscillator - wave table oscillator
//

class padthv1_oscillator
{
public:

	// ctor.
	padthv1_oscillator(padthv1_wave *wave = 0) { reset(wave); }

	// wave and phase accessors.
	void reset(padthv1_wave *wave)
		{ m_wave = wave; m_phase = 0.0f; }

	padthv1_wave *wave() const
		{ return m_wave; }
...
#endif	// __padthv1_wave_h

// end of padthv1_wave.h
