...
static const char *padthv1widget_paletteGroup = "/padthv1widget_palette/";
...
void padthv1widget_palette::nameComboActivated ( const QString& name )
{
	setPaletteName(name);
}
...
bool padthv1widget_palette::namedPalette ( const QString& name, QPalette& pal )
{
...
void padthv1widget_palette::saveNamedPalette (
...
void padthv1widget_palette::deleteNamedPalette ( const QString& name )
{
	if (m_settings) {
		m_settings->beginGroup(ColorThemesGroup);
...
QStringList padthv1widget_palette::namedPaletteList (void)
{
...
{
	if (m_settings) {
		m_settings->beginGroup(padthv1widget_paletteGroup);
