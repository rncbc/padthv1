...
// Destructor.
padthv1widget_env::~padthv1widget_env (void)
{
}


// Parameter accessors.
void padthv1widget_env::setAttack ( float fAttack )
{
...
float padthv1widget_env::attack (void) const
{
	return m_fAttack;
}


void padthv1widget_env::setDecay ( float fDecay )
{
...
float padthv1widget_env::decay (void) const
{
	return m_fDecay;
}


void padthv1widget_env::setSustain ( float fSustain )
{
...
float padthv1widget_env::sustain (void) const
{
	return m_fSustain;
}


void padthv1widget_env::setRelease ( float fRelease )
{
...
float padthv1widget_env::release (void) const
{
	return m_fRelease;
}
...
// Draw curve.
void padthv1widget_env::paintEvent ( QPaintEvent *pPaintEvent )
{
...
QRect padthv1widget_env::nodeRect ( int iNode ) const
{
...
int padthv1widget_env::nodeIndex ( const QPoint& pos ) const
{
...
void padthv1widget_env::dragNode ( const QPoint& pos )
{
	const int h  = height();
	const int w  = width();
...
// Mouse interaction.
void padthv1widget_env::mousePressEvent ( QMouseEvent *pMouseEvent )
{
...
void padthv1widget_env::mouseMoveEvent ( QMouseEvent *pMouseEvent )
{
	const QPoint& pos = pMouseEvent->pos();
	if (m_iDragNode > Idle)
		dragNode(pos);
...
void padthv1widget_env::mouseReleaseEvent ( QMouseEvent *pMouseEvent )
{
...
// Resize canvas.
void padthv1widget_env::resizeEvent ( QResizeEvent *pResizeEvent )
{
...
void padthv1widget_env::updatePolygon (void)
{
	const QRect& rect = QFrame::rect();
	const int h  = rect.height();
	const int w  = rect.width();
