...
#ifndef __padthv1_tuning_h
#define __padthv1_tuning_h
...
public:
	...
	// Default ctor.
	padthv1_tuning(float refPitch = REF_PITCH, int refNote = REF_NOTE);
...
#endif	// __padthv1_tuning_h

// end of padthv1_tuning.h
